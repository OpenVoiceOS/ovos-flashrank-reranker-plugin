...
`ovos-evidence-solver-flashrank` named `BM25SolverPlugin`, a class this package
does not define, copied from the BM25 plugin; the class is
`FlashRankEvidenceSolverPlugin`. Nothing caught it, because
...
DISTRIBUTION = "ovos-flashrank-reranker-plugin"
